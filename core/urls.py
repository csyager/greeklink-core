...
urlpatterns = [
    ...
    path('forgot_credentials_page', views.forgot_credentials_page, name='forgot_credentials_page'),
    path('forgot_credentials', views.forgot_credentials, name='forgot_credentials'),
    path('reset_password_page<int:user_id>/<str:token>', views.reset_password_page, name='reset_password_page'),
    ...
    path('support_page', views.support_request_page, name='support_page'),
